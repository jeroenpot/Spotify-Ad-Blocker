...
namespace CoreAudio
{
    public class AudioSessionControl2
    {
        ...
        internal AudioSessionControl2(IAudioSessionControl2 realAudioSessionControl2)
        {
            ...
            var _meters = _AudioSessionControl2 as IAudioMeterInformation;
            var _volume = _AudioSessionControl2 as ISimpleAudioVolume;
        ...
        {
            get { return (_AudioSessionControl2.IsSystemSoundsSession() == 0); }
        }
        ...
        internal void FireChannelVolumeChanged(UInt32 ChannelCount, IntPtr NewChannelVolumeArray, UInt32 ChangedChannel,
            Guid EventContext)
        {
            var volume = new float[ChannelCount];
            Marshal.Copy(NewChannelVolumeArray, volume, 0, (int) ChannelCount);
            if (OnChannelVolumeChanged != null)
                OnChannelVolumeChanged(this, (int) ChannelCount, volume, (int) ChangedChannel);
        }
        ...
        public delegate void ChannelVolumeChangedDelegate(
            object sender, int channelCount, Single[] newVolume, int changedChannel);
